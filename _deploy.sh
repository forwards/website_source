...
{ [ "${TRAVIS_BRANCH}" = "master" ] && [ "$TRAVIS_PULL_REQUEST" = "false" ]; } && echo push forwards.github.io build result && git push --force --quiet "https://$GITHUB_PAT@github.com/forwards/forwards.github.io" master > /dev/null 2>&1
