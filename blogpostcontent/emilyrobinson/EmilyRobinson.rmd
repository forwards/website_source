...
One big thing I want to do is host some in-person R tutorials for the R-Ladies NYC group. They had their kick-off meeting a few weeks ago, and many people expressed interest in an introduction to R tutorial and a more advanced one. While there are definitely some good resources online, my favorites are [DataCamp](https://www.datacamp.com/) for interactive tutorials and Hadley and Garrett's new "R for Data Science"" book, I do think it can sometimes be easier to learn in person. I tried to get more people in my graduate program (including professors!) to use R, so I'd love to help a group that already recognizes the value of R and is eager to learn.
...
Contact Emily via her [robinson.es@gmail.com][email address], go read her [robinsones.github.io][blog], follow her on [www.twitter.com/robinson_es](Twitter), [https://github.com/robinsones](Github), or [https://www.linkedin.com/in/robinsones](LinkedIn).
